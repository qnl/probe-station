"""Module to control the SRS lockin amplifier.

This is uesd by the probe station to acquire measurements.

Also see https://www.thinksrs.com/downloads/pdfs/manuals/SR810m.pdf for 
GPIB commands.
"""
